...
{
    class func GetToasetrIndicatorValue(Text :NSString, Position : NSString)
    {
        let ToasterView = MToaster.init()
        ToasterView.getToaster(Text, TypePosition: Position)
    }
}
